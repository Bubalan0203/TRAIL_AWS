...
import GlobalProvider, { useGlobalContext } from "./assets/contex/GlobalContext";
...
function App() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setLoading(false);
    }, 700); // Display the loading page for 3000ms
      ...
      return (
        <div className="App">
          <Routes>
            ...
            <Route path="/" element={<Dashboard />} />
            <Route path="/dashboard" element={<Dashboard />} />
            <Route path="/studentscompleted" element={<StudentsCompleted />} />
            <Route path="/referedstudents" element={<ReferedStudent />} />
            <Route path="/crm" element={<Crm />} />
            <Route path="/practise" element={<Practice />} />
            <Route path="/status" element={<Status />} />
            <Route path="*" element={<Dashboard />} />
            <Route path="/branches" element={<Branches selected={"branches"} />} />
            <Route path="/studentsdetails" element={<StudentsDetails />} />
            <Route path="/vipdetails" element={<VipDetails />} />
            <Route path="/franchisedetails" element={<FranchiseDetails />} />
