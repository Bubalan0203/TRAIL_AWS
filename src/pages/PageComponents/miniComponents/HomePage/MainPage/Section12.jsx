...
import image from '../../../../../assets/mainpage/vip3.jpg';
import image1 from '../../../../../assets/mainpage/vip1.jpg';
...
const Image = styled.img`
  ...
  height: auto;
  opacity: 0;
  animation: ${({ animate }) => (animate ? fadeInFromRight : 'none')} 1.5s forwards;

  &:nth-child(2) {
    animation: ${({ animate }) => (animate ? fadeInFromLeft : 'none')} 1.5s forwards;
  }
`;
...
const Text = styled.p`
  ...
  margin-top: 40px;
  opacity: 0;
  animation: ${({ animate }) => (animate ? fadeInFromDown : 'none')} 1.5s forwards;
...
const Texth = styled.p`
  ...
  margin: 20px 0;
  opacity: 0;
  animation: ${({ animate }) => (animate ? fadeInFromUp : 'none')} 1.5s forwards;
