                ...
                <div
                    ...
                    >
                        ...
                        <DropdownMenu className={`company-dropdown ${companyDropdown ? 'show' : ''}`}>
                            <DropdownRow>
                                <DropdownItemCompany>
                                    <DropdownItemCom><a href="/about">About Us</a></DropdownItemCom>
                                    <DropdownItemCom><a href="/about">Our Mission</a></DropdownItemCom>
                                    <DropdownItemCom><a href="/about">Help</a></DropdownItemCom>
                                    <DropdownItemCom><a href="/about">Contact Us</a></DropdownItemCom>
                                </DropdownItemCompany>
                            </DropdownRow>
                        </DropdownMenu>
                    </div>
